...
declare namespace ckeditor {
  ...
  namespace engine {
    ...
    namespace devutils {
      export function getData(model: model.Model, options?: {
      ...
      ): model.Element | model.Text | model.DocumentFragment | { model, selection };
      ...
      export function setData(
        ...
        options?: {
          rootName: string,
          selectionAttributes: { [key: string]: any }[],
          lastRangeBackward: boolean,
          batchType: 'transparent' | 'default',
        },
      ): void;
    ...
    namespace model {
      ...
      export class Element extends Node {
        ...
        getChild<T extends Node>(index: number): T;
...
declare module '@ckeditor/ckeditor5-engine/src/dev-utils/model' {
  export const getData: typeof ckeditor.engine.devutils.getData;
  export const parse: typeof ckeditor.engine.devutils.parse;
  export const setData: typeof ckeditor.engine.devutils.setData;
  export const stringify: typeof ckeditor.engine.devutils.stringify;
}
